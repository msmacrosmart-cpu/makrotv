...
import { LayoutDashboard, Users, Server, LogOut, Tv, Menu, X, Shield, ExternalLink, Download } from "lucide-react";
        ...
        <nav className="px-3 space-y-1 flex-1">
          ...
          <div className="pt-6 mt-6 border-t border-white/10 space-y-3">
            ...
            <div className="px-3 py-3 rounded-xl bg-gradient-to-br from-red-600 to-red-700 border border-red-500/30 text-white">
              ...
              <div className="text-xs text-white/90 mt-1">brstore.makro.app • v7 • 60 MB</div>
              <div className="text-xs text-white/70">Já apontado para makrotv.vercel.app</div>
              ...
              <Link href="/api/apk/info" target="_blank" className="mt-2 text-xs text-white/70 hover:text-white flex items-center justify-center gap-1">
                Ver info <ExternalLink className="w-3 h-3" />
              </Link>
            </div>
          </div>
        </nav>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="lg:hidden sticky top-0 z-30 bg-[#111111] border-b border-white/10 px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <a href="/api/apk/download" className="px-3 py-2 rounded-full bg-red-600 text-white text-xs font-bold flex items-center gap-1">
        ...
        {mobile && (
          <div className="lg:hidden bg-[#111111] border-b border-white/10 p-4 space-y-2">
            ...
            <a href="/api/apk/download" className="flex items-center gap-3 px-3 py-3 rounded-xl bg-red-600 text-white font-bold">
              <Download className="w-5 h-5" /> Baixar APK MakroTV
            </a>
            <button onClick={logout} className="w-full flex items-center gap-3 px-3 py-3 rounded-xl bg-white/5 text-white">
